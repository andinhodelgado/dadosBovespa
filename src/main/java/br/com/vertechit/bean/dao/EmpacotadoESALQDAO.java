 ...
 * @author home
 */
public class EmpacotadoESALQDAO {
    
    public void save(ArrayList<EmpacotadoESALQBean> dpb){
        ...
        try {
            for(int i = 0;i < dpb.size();i++){
                ...
                ps.setDouble(3, dpb.get(i).getVAR_DIA());
                ps.setDouble(4, dpb.get(i).getVAR_MES());
                ps.setDouble(5, dpb.get(i).getVAL_DOLAR());
                ps.executeUpdate();
            }
            ps.close();
